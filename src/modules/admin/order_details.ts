...
const match = async (order_id: string) => {
    try {
        return {
            $match: {
...
const match_order_id = async (order_id: string,_id:string) => {
    try {
        return {
            $match: {
...
const lookup_order_address = async () => {
  try {
    return {
      $lookup: {
        from: "addresses",
...
const lookup_product_order_item = async () => {
    try {
        return {
          $lookup: {
            from: "products",
...
const lookup_order_reviews = async () => {
    try {
        return {
            $lookup: {
                from: "reviews",
...
const lookup_ordered_invoice = async (order_id: any) => {
  try {
    return {
      $lookup: {
        from: "order_products",
...
export {
  ...
  unwind_users,
  lookup_address,
  lookup_order_address,
  unwind_address,
  lookup_products,
  lookup_product_order_item,
  unwind_products,
  lookup_reviews,
