...
router.get("/dashboard/graph/user", authenticator, admin_controller.user_graph)
router.get("/dashboard/graph/seller", authenticator, admin_controller.seller_graph)
router.get("/dashboard/graph/product", authenticator, admin_controller.product_graph)
router.get("/dashboard/graph/sales", authenticator, admin_controller.sales_graph)
