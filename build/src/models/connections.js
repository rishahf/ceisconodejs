...
const ConnectionSchema = (0, ts_mongoose_1.createSchema)({
    ...
    last_message: ts_mongoose_1.Type.string({ default: null }),
...
const Connectiona = (0, ts_mongoose_1.typedModel)('connection', ConnectionSchema);
exports.default = Connectiona;
