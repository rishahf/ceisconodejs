...
const ProductHighlightSchema = (0, ts_mongoose_1.createSchema)({
    product_id: ts_mongoose_1.Type.ref(ts_mongoose_1.Type.objectId({ default: null })).to('products', Models.Products),
    content: ts_mongoose_1.Type.string({ default: null }),
    updated_at: ts_mongoose_1.Type.string({ default: +new Date() }),
    created_at: ts_mongoose_1.Type.string({ default: +new Date() }),
});
const Product_Highlights = (0, ts_mongoose_1.typedModel)('product_highlights', ProductHighlightSchema);
exports.default = Product_Highlights;
