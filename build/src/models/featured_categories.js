...
const FeaturedCategoriesSchema = (0, ts_mongoose_1.createSchema)({
...
const FeaturedCategories = (0, ts_mongoose_1.typedModel)('featured_categories', FeaturedCategoriesSchema);
exports.default = FeaturedCategories;
