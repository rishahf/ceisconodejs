...
const SizeSchema = (0, ts_mongoose_1.createSchema)({
    category_id: ts_mongoose_1.Type.ref(ts_mongoose_1.Type.objectId({ default: null })).to('subcategories', models.SubCategory),
...
const Size = (0, ts_mongoose_1.typedModel)('sizes', SizeSchema);
