...
const ProductDetailSchema = (0, ts_mongoose_1.createSchema)({
    ...
    unique_number: ts_mongoose_1.Type.number({ default: 0 }),
    updated_at: ts_mongoose_1.Type.string({ default: +new Date() }),
    created_at: ts_mongoose_1.Type.string({ default: +new Date() }),
});
const ProductDetails = (0, ts_mongoose_1.typedModel)('productdetails', ProductDetailSchema);
