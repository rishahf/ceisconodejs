...
const product_helper = __importStar(require("./product_helper"));
const index_2 = require("../../middlewares/index");
class product_module {
    static find_nearest(long_from, lat_from, get_kms) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log("get_kms ", get_kms);
                var earthRadiusInMiles = 3963.19;
                let result = 100 / earthRadiusInMiles;
                let cal_radius = Number(get_kms) * 0.621371;
                let set_miles = 5;
                console.log("cal_radius -- ", cal_radius);
                let radius = get_kms == null || 0 ? result : cal_radius / earthRadiusInMiles;
...
exports.default = product_module;
_a = product_module;
product_module.details = (req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { _id } = req.query, { token } = req.headers;
        ...
        if (retrive_data.length) {
            ...
            let in_cart = yield _a.check_product_in_cart(product_id, user_id);
            let wishlisted = yield _a.check_wishlisted(product_id, user_id);
            ...
            let product_faqs = yield _a.retrive_faq_products(product_id, user_id);
            let ratings = yield _a.retrive_product_ratings(product_id);
            let ordered_product = yield _a.retrive_order_product(product_id, user_id);
...
product_module.fetch_token_data = (token) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
product_module.check_product_in_cart = (product_id, user_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let set_cart = false;
        if (user_id == null) {
            return set_cart;
...
product_module.can_add_review = (product_id, user_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
product_module.check_wishlisted = (product_id, user_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
product_module.retrive_product_details = (product_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
product_module.retrive_product_services = (product_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let query = { product_id: product_id };
        let projection = { __v: 0 };
        let options = { lean: true };
...
product_module.retrive_product_highlights = (product_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let query = { product_id: product_id };
        let projection = { __v: 0 };
        let options = { lean: true };
...
product_module.retrive_product_variations = (product_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // let query = { product_id: product_id };
        let projection = { __v: 0 };
        let options = { lean: true };
        let query = [
            yield product_helper.match_variant_product_id(product_id),
            yield product_helper.lookup_variants(),
            yield product_helper.unwind_variants(),
            yield product_helper.group_variants_data()
        ];
...
product_module.retrive_faq_products = (product_id, user_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let query = { product_id: product_id };
        let projection = { __v: 0 };
        let options = { lean: true };
        ...
        for (let value of response) {
            let faqs_likes = yield DAO.count_data(Models.FaqLikes, {
                faq_id: value._id,
                type: "LIKE",
            });
            let faq_dislikes = yield DAO.count_data(Models.FaqLikes, {
                faq_id: value._id,
                type: "DISLIKE",
            });
            ...
            if (user_id == null) {
                ...
                let likes_by_u = yield DAO.count_data(Models.FaqLikes, {
                    faq_id: value._id,
                    type: "LIKE",
                    user_id: user_id,
                });
                let dislikes_by_u = yield DAO.count_data(Models.FaqLikes, {
                    faq_id: value._id,
                    type: "DISLIKE",
                    user_id: user_id,
                });
...
product_module.retrive_order_product = (product_id, user_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let query = { product_id: product_id, user_id: user_id };
        let projection = { __v: 0 };
        let options = { lean: true };
...
product_module.searchLocation1 = (req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { product_id, lat, lng } = req;
        let query = [
            yield _a.match_product_id(product_id),
            yield _a.find_nearest(lng, lat, null),
        ];
        ...
        if (response && response.length) {
            let query_new = [
                yield _a.match_product_id(product_id),
                yield _a.find_nearest(lng, lat, response[0].radius),
            ];
            let get_data = yield DAO.aggregate_data(Models.Delivery_Locations, query_new, { lean: true });
            return get_data[0];
        }
        else {
...
product_module.searchLocation = (req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let get_product = yield DAO.get_data(Models.Products, { _id: product_id }, { __v: 0 }, { lean: true });
        ...
        if (is_delivery_available == true) {
            ...
            if (response && response.length) {
                ...
                let query_new = [
                    ...
                    yield _a.find_geo_near(lng, lat, Number(response[0].radius), product_id),
                ];
                let get_data = yield DAO.aggregate_data(Models.Delivery_Locations, query_new, { lean: true });
                ...
                if (country) {
                    ...
                    let query = [
                        yield _a.match_product_and_Country(product_id, country),
                    ];
                    let get_data = yield DAO.aggregate_data(Models.Delivery_Locations, query, { lean: true });
...
product_module.match_product_id = (product_id) => __awaiter(void 0, void 0, void 0, function* () {
    return {
        $match: {
            product_id: mongoose_1.default.Types.ObjectId(product_id),
        },
...
product_module.match_product_and_Country = (product_id, country) => __awaiter(void 0, void 0, void 0, function* () {
