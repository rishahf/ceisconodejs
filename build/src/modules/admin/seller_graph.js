...
class seller_graph extends moment_days_1.default {
...
_a = seller_graph;
seller_graph.daily_graph = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
        ...
        if (days.length) {
            for (let value of days) {
                ...
                let users = yield DAO.count_data(Models.Sellers, query);
                if (users > 0) {
                    graph_data.push({
                        hour: hour,
                        total_sellers: users
...
seller_graph.weekly_graph = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
...
seller_graph.monthly_graph = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
...
seller_graph.yearly_graph = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
