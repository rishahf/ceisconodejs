...
exports.default = coupon_module;
_a = coupon_module;
coupon_module.add = (req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let retrive_fees = yield DAO.get_data(Models.AdminFees, {}, {}, { lean: true });
        ...
        if (type == 'FIXED') {
            if (price > fee_percentage) {
                throw yield (0, index_1.handle_custom_error)("CHECK_COUPON_AMOUNT", "ENGLISH");
...
coupon_module.edit = (req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
coupon_module.list = (req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { search, pagination, limit, language } = req.query;
        let query = { is_deleted: false, added_by: "ADMIN", language: language };
        if (!!search) {
...
coupon_module.details = (req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { _id } = req.params;
...
coupon_module.delete = (req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { _id } = req.params;
        let remove_data = yield DAO.remove_data(Models.Coupons, { _id: _id });
...
coupon_module.homepage_coupon = (req) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { _id } = req.params;
        ...
        let response_data = yield DAO.get_data(Models.Coupons, query, projection, options);
        let update = {
            for_homepage: for_homepage,
        };
        if (response_data && response_data.length) {
            yield DAO.find_and_update(Models.Coupons, query, update, options);
            if (for_homepage == true || for_homepage == 'true') {
                yield DAO.find_and_update(Models.Coupons, { for_homepage: true, _id: { $ne: _id } }, { for_homepage: false }, options);
            }
            let response = yield DAO.get_data(Models.Coupons, query, projection, options);
            return response[0];
        }
        else {
            throw yield (0, index_1.handle_custom_error)("CANNOT_ADD_THIS_COUPON_TO_HOMEPAGE", "ENGLISH");
        }
    }
    catch (err) {
        throw err;
