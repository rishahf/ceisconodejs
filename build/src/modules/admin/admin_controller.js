...
const add_product_size = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let response = yield DAO.save_data(Models.Size, data);
        (0, index_1.handle_return)(res, response);
    }
    catch (err) {
        (0, index_1.handle_catch)(res, err);
...
exports.add_product_size = add_product_size;
const get_product_size = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let response = yield DAO.get_data(Models.Size, query, {}, options);
        (0, index_1.handle_return)(res, response);
    }
    catch (err) {
        (0, index_1.handle_catch)(res, err);
...
exports.get_product_size = get_product_size;
const get_single_product_size = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { _id } = req.params;
        let query = {
            _id: _id
        };
        let response = yield DAO.get_single_data(Models.Size, query, {}, { lean: true });
        (0, index_1.handle_return)(res, response);
    }
    catch (err) {
        (0, index_1.handle_catch)(res, err);
...
exports.get_single_product_size = get_single_product_size;
const delete_product_size = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { _id } = req.params;
        let query = {
            _id: _id
        };
        let response = yield DAO.remove_data(Models.Size, query);
        (0, index_1.handle_return)(res, response);
    }
    catch (err) {
        (0, index_1.handle_catch)(res, err);
...
exports.delete_product_size = delete_product_size;
const edit_product_size = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let response = yield DAO.find_and_update(Models.Size, query, update_data, { new: true });
        (0, index_1.handle_return)(res, response);
    }
    catch (err) {
        (0, index_1.handle_catch)(res, err);
...
exports.edit_product_size = edit_product_size;
