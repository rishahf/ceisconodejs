...
_a = order_graph;
order_graph.daily_graph = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
        ...
        if (days.length) {
            for (let value of days) {
                ...
                let users = yield DAO.count_data(Models.Orders, query);
                if (users > 0) {
                    graph_data.push({
                        hour: hour,
                        total_orders: users
...
order_graph.weekly_graph = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
...
order_graph.monthly_graph = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
...
order_graph.yearly_graph = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
