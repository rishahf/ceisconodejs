...
exports.sort_data = exports.match_data = exports.group_invoice_data = exports.group_other_items = exports.group_data1 = exports.group_data = exports.lookup_product_invoice = exports.unwind_invoice = exports.lookup_order_invoice = exports.lookup_ordered_invoice = exports.unwind_address = exports.lookup_address = exports.lookup_reviews_data = exports.unwind_products = exports.lookup_other_product = exports.lookup_products = exports.lookup_ordered_products = exports.unwind_order_products = exports.lookup_order_products = exports.unwind_users = exports.lookup_users = exports.unwind_sellers = exports.lookup_sellers = exports.unwind_orders = exports.lookup_order = exports.match_order_id = exports.match = void 0;
...
const lookup_other_product = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
            $lookup: {
                from: "products",
...
exports.lookup_other_product = lookup_other_product;
...
const lookup_reviews_data = (user_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
            $lookup: {
                from: "reviews",
                ...
                pipeline: [
                    {
                        $match: {
                            $expr: {
                                $and: [
                                    {
                                        $eq: ["$user_id", mongoose_1.default.Types.ObjectId(user_id)],
                                    },
                                    {
...
const group_other_items = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
            $group: {
                _id: "$_id",
...
exports.group_other_items = group_other_items;
...
const match_order_id = (order_id, user_id, _id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
            $match: {
...
const lookup_ordered_invoice1 = (order_id, user_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
            $lookup: {
                from: "order_products",
...
const lookup_ordered_invoice = (order_id, user_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return {
            $lookup: {
                from: "orders",
    ...
    try {
        return {
            $match: {
                ...
                user_id: mongoose_1.default.Types.ObjectId(seller_id),
            },
        };
    }
    catch (err) {
