...
class product_graph extends moment_days_1.default {
    static retrive_graph(req) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let response = [];
                if (graph_type == 'DAILY') {
                    response = yield this.daily_graph(seller_id);
                }
                if (graph_type == 'WEEKLY') {
                    response = yield this.weekly_graph(seller_id);
                }
                if (graph_type == 'MONTHLY') {
                    response = yield this.monthly_graph(seller_id);
                }
                if (graph_type == 'YEARLY') {
                    response = yield this.yearly_graph(seller_id);
                }
                return {
...
_a = product_graph;
product_graph.daily_graph = (seller_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
        ...
        if (days.length) {
            for (let value of days) {
                ...
                let users = yield DAO.count_data(Models.Products, query);
                if (users > 0) {
                    graph_data.push({
                        hour: hour,
...
product_graph.weekly_graph = (seller_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
...
product_graph.monthly_graph = (seller_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
...
product_graph.yearly_graph = (seller_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let graph_data = [];
